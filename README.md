...
## APIs:
API Base URL: https://melrose-frontend-challenge.us-west-2.elasticbeanstalk.com.  Please make sure to send your email address as the Authorization header with each API request.
